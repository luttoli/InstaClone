...
let fridend6Feed: Feed = Feed(nickName: "fridend6", profileImage: UIImage(named: "feedProfileImage.png"), location: nil, feedImage: [], likeStatus: false, likedBy: [LikedbyData.likedList[0]], likeCount: 99999, content: "We first met at Gwanghwamun. I was eating steak, but it came out late.", comment: [])

let fridend7Feed: Feed = Feed(nickName: "fridend7", profileImage: UIImage(named: "feedProfileImage.png"), location: "Jeju, Korea", feedImage: [], likeStatus: false, likedBy: [LikedbyData.likedList[1]], likeCount: 9999, content: "I went to Jeju Island to live for a month.", comment: [])

let fridend8Feed: Feed = Feed(nickName: "fridend8", profileImage: UIImage(named: "feedProfileImage.png"), location: "Merlion Park, Singapore", feedImage: [], likeStatus: false, likedBy: [LikedbyData.likedList[2]], likeCount: 999, content: "We went to Singapore for our first overseas trip together. I found out later that it was a national holiday.", comment: [])
...
let fridend10Feed: Feed = Feed(nickName: "fridend10", profileImage: UIImage(named: "feedProfileImage.png"), location: "Cancun, Mexico", feedImage: [], likeStatus: false, likedBy: [LikedbyData.likedList[4]], likeCount: 9999999, content: "All-inclusive stay in Cancun is unforgettable. I want to eat non-alcoholic fida cola again.", comment: [])
